...
//    }
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass,
        ...
        FullyQualifiedJavaType ptype = new FullyQualifiedJavaType("com.cms.shop.dao.base.BaseMapper");
    ...
    public boolean modelBaseRecordClassGenerated(TopLevelClass topLevelClass,
                                                 IntrospectedTable introspectedTable) {
        // 实体类添加统一父接口
        FullyQualifiedJavaType ptype = new FullyQualifiedJavaType("com.cms.shop.model.base.BaseBean");
    ...
    public boolean modelExampleClassGenerated(TopLevelClass topLevelClass,
                                              IntrospectedTable introspectedTable) {
        // 所有类条件类添加统一父接口
        FullyQualifiedJavaType ptype = new FullyQualifiedJavaType("com.cms.shop.model.base.BaseCriteria");
        topLevelClass.addImportedType(ptype);
        topLevelClass.addSuperInterface(ptype);
        //cobra add
        //添加实体的序列化号
