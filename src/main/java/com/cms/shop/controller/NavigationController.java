    ...
    private String getNavJson(){
      ...
      /*  JSONObject  object12 = new JSONObject();
       ...
       /* JSONObject  object18 = new JSONObject();
        ...
        object24.put("id","15");
        object24.put("dir","manage");
        object24.put("html","manage.html");
        ...
        JSONObject object74 = new JSONObject();
        object74.put("id","15");
        object74.put("name","物业管理");
        object74.put("icon","");
